package Day_13.Anand;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

public class gridPartition2 {
    public static void main(String[] args) {
        Solution sol = new Solution();

        // Test Case 1: From your previous example [[4],[3],[4],[4],[4]]
        int[][] grid1 = {
            {4},
            {3},
            {4},
        ...
        System.out.println("Test 1 Result: " + sol.canPartitionGrid(grid1));

        // Test Case 2: [[1,2,4],[2,3,5]]
        int[][] grid2 = {
            {1, 2, 4},
            {2, 3, 5}
        };
        System.out.println("Test 2 Result: " + sol.canPartitionGrid(grid2));
    }
